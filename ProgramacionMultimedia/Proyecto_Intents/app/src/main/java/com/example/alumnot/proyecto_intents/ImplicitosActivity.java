...
public class ImplicitosActivity extends Activity {
    ...
    public void lanzarActivity(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.verWeb: // Abre la pagina declarada con el navegador que elija el usuario
            ...
            case R.id.verContactos: // Abre la aplicacion Contactos
                i = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("content://contacts/people/"));
                startActivity(i);
                break;

            case R.id.llamar: // Abre la aplicación Llamadas con el telefono declarado	
                i = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("tel:6574837475"));
                startActivity(i);
                break;

            case R.id.google: // Abre el buscador con el texto declarado
            ...
            case R.id.mail: // Abre la aplicion de email que elija el usuario con los campos completados
            ...
            case R.id.mapas: // Abre la aplicacion de mapas
            ...
            case R.id.galeria: // Abre la galeria
            ...
            case R.id.camara: // Abre la camara
